...
def main():
    ...
    testFile1 = f"/home/user/Desktop/Sand and Star/BashOrchestrationProgram_BOP/data/NOAA(elevation tiles)/megafile_mask"
    outputFile1 = f"/home/user/Desktop/Sand and Star/BashOrchestrationProgram_BOP/data/NOAA(elevation tiles)/RF_megafile_mask"
    ...
    fileGridsReformat(testFile1, outputFile1, 21600, 43200, [4800,6000])

    #fileMajorVoteDownscale(testFile,outputFile,21600,43200,8)
    #downsampleModeFile(testFile, outputFile,16,43200,21600)
    downsampleFile(testFile, outputFile,20,43200,21600)
